            ...
            <div className="login_box">
                ...
                <form name='login' method='post'>
                    ...
                    <div className="input_style">
                        ...
                        <input type='text' id='email' name='youEmail' placeholder='E-mail' autoComplete='off' required></input>
                    </div>

                    <div className="input_style">
                        <p>아이디</p>
                        <label htmlFor="id" className='blind'>아이디</label>
                        <input type='id' id='id' name='youId' placeholder='ID' autoComplete='off' required></input>
                    </div>
